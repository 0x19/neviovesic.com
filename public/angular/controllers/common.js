...
(function() {
  var FooterCtrl, HeaderCtrl, NavigationCtrl, PageCtrl,
    __slice = [].slice,
  ...
  PageCtrl = (function(_super) {
    __extends(PageCtrl, _super);

    function PageCtrl() {
      return PageCtrl.__super__.constructor.apply(this, arguments);
    }

    PageCtrl.register(app);

    PageCtrl.inject('$scope', '$state', 'Page');

    PageCtrl.prototype.initialize = function() {
      this.Page.fetchPageData();
      return this.Page.setPageHeaders(this.$state.current.name);
    };
  ...
  FooterCtrl = (function(_super) {
    ...
    FooterCtrl.prototype.initialize = function() {
      FooterCtrl.__super__.initialize.apply(this, arguments);
      return this.$scope.date = new Date;
    };

...
import (
	...
	_ "neviovesic/app"
	controllers "neviovesic/app/controllers"
	tests "neviovesic/tests"
)
...
func main() {
	...
	revel.RegisterController((*controllers.Service)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Nagios",
	...
	revel.RegisterController((*controllers.Templates)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "PageData",
				Args: []*revel.MethodArg{ 
